...
export default function App() {
  ...
  const [chartStates, setChartStates] = useState<Record<string, ChartState>>({
    ...
    "portfolio-asset-allocation": { minimized: false, title: "Random Sample Run 1 Asset Allocation", tab: "portfolio" },
    ...
    "drawdown-asset-allocation": { minimized: false, title: "Random Sample Run 1 Asset Allocation", tab: "drawdown" },
    "portfolio-sample-2-asset-allocation": { minimized: true, title: "Random Sample Run 2 Asset Allocation", tab: "portfolio" },
    "portfolio-sample-3-asset-allocation": { minimized: true, title: "Random Sample Run 3 Asset Allocation", tab: "portfolio" },
    "portfolio-sample-4-asset-allocation": { minimized: true, title: "Random Sample Run 4 Asset Allocation", tab: "portfolio" },
    "portfolio-sample-5-asset-allocation": { minimized: true, title: "Random Sample Run 5 Asset Allocation", tab: "portfolio" },
    "portfolio-sample": { minimized: false, title: "Random Sample Run 1 Trajectory", tab: "portfolio" },
    "portfolio-sample-2-trajectory": { minimized: true, title: "Random Sample 2 Run Trajectory", tab: "portfolio" },
    "portfolio-sample-3-trajectory": { minimized: true, title: "Random Sample Run 3 Trajectory", tab: "portfolio" },
    "portfolio-sample-4-trajectory": { minimized: true, title: "Random Sample Run 4 Trajectory", tab: "portfolio" },
    "portfolio-sample-5-trajectory": { minimized: true, title: "Random Sample Run 5 Trajectory", tab: "portfolio" },
    "drawdown-sample": { minimized: false, title: "Random Sample Run 1 Trajectory", tab: "drawdown" },
    "drawdown-sample-2-asset-allocation": { minimized: true, title: "Random Sample Run 2 Asset Allocation", tab: "drawdown" },
    "drawdown-sample-3-asset-allocation": { minimized: true, title: "Random Sample Run 3 Asset Allocation", tab: "drawdown" },
    "drawdown-sample-4-asset-allocation": { minimized: true, title: "Random Sample 4 Run Asset Allocation", tab: "drawdown" },
    "drawdown-sample-5-asset-allocation": { minimized: true, title: "Random Sample Run 5 Asset Allocation", tab: "drawdown" },
    "drawdown-sample-2-trajectory": { minimized: true, title: "Random Sample Run 2 Trajectory", tab: "drawdown" },
    "drawdown-sample-3-trajectory": { minimized: true, title: "Random Sample Run 3 Trajectory", tab: "drawdown" },
    "drawdown-sample-4-trajectory": { minimized: true, title: "Random Sample Run 4 Trajectory", tab: "drawdown" },
    "drawdown-sample-5-trajectory": { minimized: true, title: "Random Sample Run 5 Trajectory", tab: "drawdown" },
  });
