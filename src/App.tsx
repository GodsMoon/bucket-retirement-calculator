...
export default function App() {
  ...
  const [chartStates, setChartStates] = useState<Record<string, ChartState>>({
    ...
    "sp500-sample": { minimized: false, title: "Sample Run Trajectory", tab: "sp500", chartType: "sample-trajectory" },
    "nasdaq100-trajectory": { minimized: false, title: "Portfolio Trajectory Bands", tab: "nasdaq100", chartType: "trajectory-bands" },
    "nasdaq100-sample": { minimized: false, title: "Sample Run Trajectory", tab: "nasdaq100", chartType: "sample-trajectory" },
