...
export default function App() {
  ...
  const [chartOrder, setChartOrder] = useState<Record<string, string[]>>({
    ...
    portfolio: ["portfolio-trajectory", "portfolio-median-trajectory", "portfolio-sample", "portfolio-sample-2-trajectory", "portfolio-sample-3-trajectory", "portfolio-sample-4-trajectory", "portfolio-sample-5-trajectory"],
    drawdown: ["drawdown-trajectory", "drawdown-median-trajectory", "drawdown-sample", "drawdown-sample-2-trajectory", "drawdown-sample-3-trajectory", "drawdown-sample-4-trajectory", "drawdown-sample-5-trajectory"],
  });
