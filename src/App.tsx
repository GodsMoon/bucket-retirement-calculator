...
export default function App() {
  ...
  const [chartStates, setChartStates] = useState<Record<string, ChartState>>({
    ...
    "portfolio-asset-allocation": { minimized: false, title: "1 Random Sample Run Asset Allocation", tab: "portfolio" },
    "portfolio-sample": { minimized: false, title: "1 Random Sample Run Trajectory", tab: "portfolio" },
    "portfolio-sample-2-asset-allocation": { minimized: true, title: "2 Random Sample Run Asset Allocation", tab: "portfolio" },
    "portfolio-sample-2-trajectory": { minimized: true, title: "2 Random Sample Run Trajectory", tab: "portfolio" },
    "portfolio-sample-3-asset-allocation": { minimized: true, title: "3 Random Sample Run Asset Allocation", tab: "portfolio" },
    "portfolio-sample-3-trajectory": { minimized: true, title: "3 Random Sample Run Trajectory", tab: "portfolio" },
    "portfolio-sample-4-asset-allocation": { minimized: true, title: "4 Random Sample Run Asset Allocation", tab: "portfolio" },
    "portfolio-sample-4-trajectory": { minimized: true, title: "4 Random Sample Run Trajectory", tab: "portfolio" },
    "portfolio-sample-5-asset-allocation": { minimized: true, title: "5 Random Sample Run Asset Allocation", tab: "portfolio" },
    "portfolio-sample-5-trajectory": { minimized: true, title: "5 Random Sample Run Trajectory", tab: "portfolio" },
    ...
    "drawdown-asset-allocation": { minimized: false, title: "1 Random Sample Run Asset Allocation", tab: "drawdown" },
    "drawdown-sample": { minimized: false, title: "1 Random Sample Run Trajectory", tab: "drawdown" },
    "drawdown-sample-2-asset-allocation": { minimized: true, title: "2 Random Sample Run Asset Allocation", tab: "drawdown" },
    "drawdown-sample-2-trajectory": { minimized: true, title: "2 Random Sample Run Trajectory", tab: "drawdown" },
    "drawdown-sample-3-asset-allocation": { minimized: true, title: "3 Random Sample Run Asset Allocation", tab: "drawdown" },
    "drawdown-sample-3-trajectory": { minimized: true, title: "3 Random Sample Run Trajectory", tab: "drawdown" },
    "drawdown-sample-4-asset-allocation": { minimized: true, title: "4 Random Sample Run Asset Allocation", tab: "drawdown" },
    "drawdown-sample-4-trajectory": { minimized: true, title: "4 Random Sample Run Trajectory", tab: "drawdown" },
    "drawdown-sample-5-asset-allocation": { minimized: true, title: "5 Random Sample Run Asset Allocation", tab: "drawdown" },
    "drawdown-sample-5-trajectory": { minimized: true, title: "5 Random Sample Run Trajectory", tab: "drawdown" },
  });
