...
export type ChartType = "trajectory-bands" | "sample-trajectory" | "asset-allocation";
...
export default function App() {
  ...
  const [chartStates, setChartStates] = useState<Record<string, ChartState>>({
    "sp500-trajectory": { minimized: false, title: "Portfolio Trajectory Bands", tab: "sp500", chartType: "trajectory-bands" },
    "sp500-sample": { minimized: false, title: "Sample Run 1 Trajectory", tab: "sp500", chartType: "sample-trajectory" },
    "sp500-sample-2": { minimized: true, title: "Sample Run 2 Trajectory", tab: "sp500", chartType: "sample-trajectory" },
    "sp500-sample-3": { minimized: true, title: "Sample Run 3 Trajectory", tab: "sp500", chartType: "sample-trajectory" },
    "sp500-sample-4": { minimized: true, title: "Sample Run 4 Trajectory", tab: "sp500", chartType: "sample-trajectory" },
    "sp500-sample-5": { minimized: true, title: "Sample Run 5 Trajectory", tab: "sp500", chartType: "sample-trajectory" },
    "nasdaq100-trajectory": { minimized: false, title: "Portfolio Trajectory Bands", tab: "nasdaq100", chartType: "trajectory-bands" },
    "nasdaq100-sample": { minimized: false, title: "Sample Run 1 Trajectory", tab: "nasdaq100", chartType: "sample-trajectory" },
    "nasdaq100-sample-2": { minimized: true, title: "Sample Run 2 Trajectory", tab: "nasdaq100", chartType: "sample-trajectory" },
    "nasdaq100-sample-3": { minimized: true, title: "Sample Run 3 Trajectory", tab: "nasdaq100", chartType: "sample-trajectory" },
    "nasdaq100-sample-4": { minimized: true, title: "Sample Run 4 Trajectory", tab: "nasdaq100", chartType: "sample-trajectory" },
    "nasdaq100-sample-5": { minimized: true, title: "Sample Run 5 Trajectory", tab: "nasdaq100", chartType: "sample-trajectory" },
    "portfolio-trajectory": { minimized: false, title: "Portfolio Trajectory Bands", tab: "portfolio", chartType: "trajectory-bands" },
    "portfolio-median-asset-allocation": { minimized: false, title: "Median Sample Run Asset Allocation", tab: "portfolio", chartType: "asset-allocation" },
    "portfolio-median-trajectory": { minimized: false, title: "Median Sample Run Trajectory", tab: "portfolio", chartType: "sample-trajectory" },
    "portfolio-asset-allocation": { minimized: false, title: "Random Sample Run 1 Asset Allocation", tab: "portfolio", chartType: "asset-allocation" },
    "drawdown-trajectory": { minimized: false, title: "Portfolio Trajectory Bands", tab: "drawdown", chartType: "trajectory-bands" },
    "drawdown-median-asset-allocation": { minimized: false, title: "Median Sample Run Asset Allocation", tab: "drawdown", chartType: "asset-allocation" },
    "drawdown-median-trajectory": { minimized: false, title: "Median Sample Run Trajectory", tab: "drawdown", chartType: "sample-trajectory" },
    "drawdown-asset-allocation": { minimized: false, title: "Random Sample Run 1 Asset Allocation", tab: "drawdown", chartType: "asset-allocation" },
    "portfolio-sample-2-asset-allocation": { minimized: true, title: "Random Sample Run 2 Asset Allocation", tab: "portfolio", chartType: "asset-allocation" },
    "portfolio-sample-3-asset-allocation": { minimized: true, title: "Random Sample Run 3 Asset Allocation", tab: "portfolio", chartType: "asset-allocation" },
    "portfolio-sample-4-asset-allocation": { minimized: true, title: "Random Sample Run 4 Asset Allocation", tab: "portfolio", chartType: "asset-allocation" },
    "portfolio-sample-5-asset-allocation": { minimized: true, title: "Random Sample Run 5 Asset Allocation", tab: "portfolio", chartType: "asset-allocation" },
    "portfolio-sample": { minimized: false, title: "Random Sample Run 1 Trajectory", tab: "portfolio", chartType: "sample-trajectory" },
    "portfolio-sample-2-trajectory": { minimized: true, title: "Random Sample 2 Run Trajectory", tab: "portfolio", chartType: "sample-trajectory" },
    "portfolio-sample-3-trajectory": { minimized: true, title: "Random Sample Run 3 Trajectory", tab: "portfolio", chartType: "sample-trajectory" },
    "portfolio-sample-4-trajectory": { minimized: true, title: "Random Sample Run 4 Trajectory", tab: "portfolio", chartType: "sample-trajectory" },
    "portfolio-sample-5-trajectory": { minimized: true, title: "Random Sample Run 5 Trajectory", tab: "portfolio", chartType: "sample-trajectory" },
    "drawdown-sample": { minimized: false, title: "Random Sample Run 1 Trajectory", tab: "drawdown", chartType: "sample-trajectory" },
    "drawdown-sample-2-asset-allocation": { minimized: true, title: "Random Sample Run 2 Asset Allocation", tab: "drawdown", chartType: "asset-allocation" },
    "drawdown-sample-3-asset-allocation": { minimized: true, title: "Random Sample Run 3 Asset Allocation", tab: "drawdown", chartType: "asset-allocation" },
    "drawdown-sample-4-asset-allocation": { minimized: true, title: "Random Sample Run 4 Asset Allocation", tab: "drawdown", chartType: "asset-allocation" },
    "drawdown-sample-5-asset-allocation": { minimized: true, title: "Random Sample Run 5 Asset Allocation", tab: "drawdown", chartType: "asset-allocation" },
    "drawdown-sample-2-trajectory": { minimized: true, title: "Random Sample Run 2 Trajectory", tab: "drawdown", chartType: "sample-trajectory" },
    "drawdown-sample-3-trajectory": { minimized: true, title: "Random Sample Run 3 Trajectory", tab: "drawdown", chartType: "sample-trajectory" },
    "drawdown-sample-4-trajectory": { minimized: true, title: "Random Sample Run 4 Trajectory", tab: "drawdown", chartType: "sample-trajectory" },
    "drawdown-sample-5-trajectory": { minimized: true, title: "Random Sample Run 5 Trajectory", tab: "drawdown", chartType: "sample-trajectory" },
  });

  const [chartOrder, setChartOrder] = useState<Record<string, string[]>>({
    sp500: ["sp500-trajectory", "sp500-sample", "sp500-sample-2", "sp500-sample-3", "sp500-sample-4", "sp500-sample-5"],
    nasdaq100: ["nasdaq100-trajectory", "nasdaq100-sample", "nasdaq100-sample-2", "nasdaq100-sample-3", "nasdaq100-sample-4", "nasdaq100-sample-5"],
