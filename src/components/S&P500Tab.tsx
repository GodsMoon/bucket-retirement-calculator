  ...
  const charts: Record<string, React.ReactNode> = {
    ...
    'sp500-sim-mode': (
      <Chart
        ...
        onRefresh={onRefresh}
        onMinimize={() => toggleMinimize('sp500-sim-mode')}
        minimizable={chartStates['sp500-sim-mode'].minimizable}
      >
    ...
    'sp500-trajectory': (
      <Chart
        ...
        minimizable={chartStates['sp500-trajectory'].minimizable}
      >
        {stats && (
          <div className="h-80">
    ...
    'sp500-sample': (
      <Chart
        ...
        minimizable={chartStates['sp500-sample'].minimizable}
      >
        {sampleRun && (
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
